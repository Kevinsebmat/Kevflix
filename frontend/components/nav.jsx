    ...
    render() {
        ...
        if (page === "splash") {
            ...
            navRight=(
                <div className="nav-right">
                    <div className="nav-buttons-box">
                        <div onClick={this.handleDemo} className="nav-button unselectable-text">Demo</div>
                    </div>
                </div>
            )
                    ...
                    activeProfileStyle=(
                        <div className="profiles-dropdown-top" key={currentProf.id} >
                            ...
                            <div className={`current-profile gradient-${i + 1}`}>
                                <div className="kevflix-profile-img"></div>
                            </div>
                            ...
                            <div className="dropdown-bottom-box">
                                ...
                                <div className="dropdown-main">
                                    ...
                                    <div className="dropdown-main-bottom">
                                        <div className="dropdown-section">
                                            <p className="dropdown-link last" onClick={this.handleLogout}>Sign out of Kevflix</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
